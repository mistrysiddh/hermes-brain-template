...
skill_cand = os.path.join(VAULT, "02-Areas", "Skills", "Skill-to-Chat-Links.md")
SKILL_LINKS = skill_cand if os.path.exists(os.path.dirname(skill_cand)) else os.path.join(VAULT, "Skills-Notes", "Skill-to-Chat-Links.md")
