...
param(
    ...
    [string]$Path = $(if (Test-Path (Join-Path $env:HERMES_VAULT_PATH "04-Archives\Daily")) { Join-Path $env:HERMES_VAULT_PATH "04-Archives\Daily" } else { Join-Path $env:HERMES_VAULT_PATH "Daily" }),
