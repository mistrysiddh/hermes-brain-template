...
res_cand = os.path.join(VAULT, "03-Resources", "Research")
res_dir = res_cand if os.path.exists(res_cand) else os.path.join(VAULT, "Research")
out_dir = os.path.join(res_dir, "Supermemory")
