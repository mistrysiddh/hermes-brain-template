...
This is distinct from [[Skills-Notes/Team-Profiles-Index|Team-Profiles-Index]]
...
> the details belong in [[Projects]] or [[Research]] notes instead, with
...
re-explain every session. Promoted here from [[Memory-Review/TEMPLATE|Memory-Review]]
...
See also: [[MOC]] (topic index), [[Skills-Notes/Team-Profiles-Index|Team-Profiles-Index]] (agent profiles, not you).
